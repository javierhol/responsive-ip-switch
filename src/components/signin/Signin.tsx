...
import Logo from '../../images/Responsive IP Project-01.png'
...
function Signin() {
    ...
    const handleLogin = (e: React.FormEvent) => {
        ...
        if (form.email === database[0].email && form.password === database[0].password) {
           navigate('/dashboard')
        } else {
                ...
                <div className="shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] max-w-6xl rounded-md p-6">
                    ...
                    <div className="grid md:grid-cols-2 items-center gap-8">
                        <div className="max-md:order-1">
                            <img src={Logo} className="lg:w-11/12 w-full object-cover" alt="login-image" />
                        </div>
                        <form className="max-w-md w-full mx-auto" onSubmit={handleLogin}>
                            <div className="mb-12">
                            ...
                            <div className="mt-8">
                                <div className="relative flex items-center">
                                    <input name="password" type="password" required className="w-full text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" onChange={handleInputChange} />
